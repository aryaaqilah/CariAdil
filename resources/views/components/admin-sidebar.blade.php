  ...
  <aside id="sidebar" class="sidebar">
    ...
    <div class="sidebar-top d-flex">
      <img src="/assets/img/Logo Cari Adil 1.png" class="m-2 pb-3" width="55rem" alt="">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="/role">
          <i class="bi bi-layout-text-window-reverse"></i><span>Role</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
