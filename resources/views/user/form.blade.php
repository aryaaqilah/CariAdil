...
<<<<<<< HEAD
    ...
    <div class="container card">
        <form class="row g-3 needs-validation pe-4" style="width: 100%" novalidate>
=======
    <div class="container">
        <div class="pembatas"></div>
        <form action="/form-pengajuan-hukum" method="POST" class="card p-3 mt-5 needs-validation" style="width: 100%"
            novalidate>
            @csrf
            @method('POST')
>>>>>>> 9105323a0e8b9c46aa4ee5f38406e2154a6710ff
            <div class="pembatas"></div>
...
=======
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nomor Pemohon</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="Nomor Pemohon" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row me-4 ms-4 mt-3">
                <div class="col-5">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">RT/RW</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="RT/RW"
                            required>
                    </div>
                </div>
                <div class="col-2"></div>
            ...
            <div class="row me-4 ms-4 mt-3">
                <div class="col-5">
                    <div class="">
                        <label for="exampleFormControlInput1" class="form-label">Nomor Keterangan Tidak
                            Mampu</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="Nomor Keterangan Tidak Mampu" required>
                    </div>
            ...
            <div class="row me-4 ms-4 mt-3">
                <p>Demikian permohonan ini saya buat dengan sesungguhnya untuk keperluan mendapatkan bantuan
                    hukum.</p>
                <label for="exampleFormControlInput1" class="form-label">Dibuat di:</label>
                <div class="col-5">
